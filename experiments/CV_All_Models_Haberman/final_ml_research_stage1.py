...
maf_config = {
    ...
    "train": {
        "data_type": "real_data",
        "real_data": {
            "train_data_path": "./dataset/Haberman/Milad.csv",
            "test_data_path": None,
            "val_data_path": None,
            "split_data_again": True,
            "features": ["Age_of_patient_at_time_of_operation", "Patients_year_of_operation", "Number_of_positive_axillary_nodes_detected"],
            "label_feature": "Survival_status"},
        "toy_data": {
        ...
        "log_path": "./log_train/",
        "batch_size": 800,
        "hidden_shape": [5, 5, 5, 5, 5, 5, 5, 5, 5],
        "layers": 10,
        "base_lr": 1e-5,
        "end_lr": 1e-6,
        "max_epochs": 5e3,
...
#         categorical_features = config['train']['real_data']['categorical_features']
        numeric_features = [col for col in config['train']['real_data']['features']]
